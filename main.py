...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', default="../data/conll2003/saved_model")
    parser.add_argument('--savedset', help='Dir of saved data setting', default="../data/conll2003/saved_model/save.dset")
    ...
    if status == 'train':
        ...
        if emb == "senna":
            ...
            emb_file = "../data/glove.6B/glove.6B.100d.txt"  ### catner
        elif emb == "ctb":

...
from model.covebilstmcrf import Cove_BiLSTM_CRF as SeqModel
from utils.covedata import Data
import visdom
...
def train(data, save_model_dir, seg=True):
    ...
    for idx in range(data.HP_iteration):
        ...
        for batch_id in range(total_batch):
            ...
            instance_count += 1
            loss, tag_seq = model.neg_log_likelihood_loss(batch_word, batch_wordlen, batch_char, batch_charlen,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', default="../data/conll2003/cove/saved_model")
    parser.add_argument('--savedset', help='Dir of saved data setting',
                        default="../data/conll2003/cove/saved_model/save.dset")
    ...
    if status == 'train':
        ...
        if emb == "senna":
            ...
            emb_file = "../data/glove.840B/glove.840B.300d.txt"  ### catner
        elif emb == "ctb":
